...
class PlayState extends MusicBeatState
{
	...
	var bgJhon:BGSprite;
	var skyJhon:BGSprite;
	var floorJhon:BGSprite;
	var mountainsJhon:BGSprite;

	var skyJhonday:BGSprite;
	var floorJhonday:BGSprite;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'wife-bg': //Week 1
				var sky:BGSprite = new BGSprite('bas/sky', -600, -200, 0.7, 0.7);
				sky.scale.set(1.3, 1.3);
				add(sky);
				
				var bg:BGSprite = new BGSprite('bas/bg', -600, -200, 1, 1);
				add(bg);

				var floor:BGSprite = new BGSprite('bas/floor', -600, -200, 1, 1);
				add(floor);
            case 'wife-bg-re':
				var sky:BGSprite = new BGSprite('basre/skyRE', -600, -200, 0.7, 0.7);
				sky.scale.set(1.3, 1.3);
				add(sky);
				
				var floor:BGSprite = new BGSprite('basre/floorRE', -600, -200, 1, 1);
				add(floor);
			case 'tmk-bg': //Week 1
				var sky:BGSprite = new BGSprite('tmk/sky', -400, -200, 0.7, 0.7);
				sky.scale.set(8, 8);
				sky.antialiasing = false;
				add(sky);
				
				skyded = new BGSprite('tmk/sky-dead', -400, -200, 0.7, 0.7);
				skyded.scale.set(8, 8);
				skyded.antialiasing = false;
				add(skyded);
					
				var bg:BGSprite = new BGSprite('tmk/bg', -600, -200, 1, 1);
				bg.scale.set(8, 8);
				bg.antialiasing = false;
				add(bg);
				
			case 'jhon-bg': //Week 1
				skyJhon = new BGSprite('jhon/Sky_Day', -100, -200, 0, 0);
				skyJhon.scale.set(3, 3);
				add(skyJhon);

				mountainsJhon = new BGSprite('jhon/Mountains_Day', -100, -250, 0.7, 0.7);
				mountainsJhon.scale.set(2, 2);
				add(mountainsJhon);
				
				bgJhon = new BGSprite('jhon/Barrier_Day', -200, -150, 1, 1);
				bgJhon.scale.set(2, 2.5);
				add(bgJhon);

				floorJhon = new BGSprite('jhon/Floor_Day', -600, -200, 1, 1);
				floorJhon.scale.set(1.2, 1.2);
				add(floorJhon);
		}
